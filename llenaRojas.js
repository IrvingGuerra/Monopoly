...
fs.readFile("./rojas.json", (err, data) => {
    ...
    root.cards.length = 0;
    root.cards.push(argsToObject("Denunciado por enviar fotos indebidas a una alumna!!, pierdes & turnos por degenerado."));
    ...
    root.cards.push(argsToObject("Te cacharon robando una laptop, pierdes & turnos y pagas # pesos al banco."));
    ...
    root.cards.push(argsToObject("Te enteraste de que la niña que te gustaba era un metalero, pierdes # pesos y pierdes & turnos por acoso."));
    ...
    root.cards.push(argsToObject("¡¡Te cachan copiando en un examen, pierdes & turnos por jugarle al vivo!!"));
    ...
    root.cards.push(argsToObject("Compraste una tarjeta del metro de las que cuestan 50 y traen 120 de saldo, pierdes & turnos y pagas # pesos."));
    ...
    root.cards.push(argsToObject("Le hackeaste el Facebook a un amigo, pierdes & turnos."));
